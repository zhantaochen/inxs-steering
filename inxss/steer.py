...
class ExperimentSteerer:
    ...
    def compute_likelihood(self, next_measurement, next_mask, likelihood_mask):
        ...
        poisson_negative_log_likelihood = torch.nn.functional.poisson_nll_loss(
            self.experiment.neutron_flux * predictions.clip(0.), 
            next_measurement[None], log_input=False, reduction="none").mean(dim=-1)
    ...
    def step_steer(self, ):
        ...
        next_measurement = self.experiment.get_measurements_by_mask(next_mask, poisson=True)
